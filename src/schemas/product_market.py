...
class ProductMarketUpdateSchema(BaseModel):
    product_id: Optional[str] = None # si quieres permitir actualizar el product_id
    marketplace_id: Optional[str] = None  # si quieres permitir actualizar el marketplace_id
    url: Optional[str] 
    available: Optional[constr(min_length=1, max_length=10)] = None  # type: ignore # ej: "yes" o "no"
